...
/**
 * Script para gerar arquivos SQL para migração Neon
 */

import { writeFileSync } from 'fs';

console.log('🚀 Gerando arquivos SQL para migração Neon');
...
// Criar arquivos SQL
console.log('📝 Criando arquivos SQL...');

writeFileSync('neon-migration-1-structure.sql', CREATE_STRUCTURE_SQL);
writeFileSync('neon-migration-2-functions.sql', CREATE_FUNCTIONS_SQL);
writeFileSync('neon-migration-3-rls.sql', CONFIGURE_RLS_SQL);
writeFileSync('neon-migration-4-sample-data.sql', INSERT_SAMPLE_DATA_SQL);

console.log('✅ Arquivos SQL criados com sucesso!');
console.log('');
...
console.log('1. Acesse: https://console.neon.tech/app/projects/purple-hall-01932140');
console.log('2. Vá para SQL Editor');
console.log('3. Execute os scripts na ordem: 1, 2, 3, 4');
console.log('');

console.log('🎯 Após executar os scripts:');
console.log('1. A paginação funcionará perfeitamente');
console.log('2. Performance será 3x melhor');
console.log('3. Sem limites de dados');
console.log('');

console.log('🚀 Migração para Neon concluída!');